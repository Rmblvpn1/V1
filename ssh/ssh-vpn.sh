...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Rmblvpn1/V4/main/issue.net"
...
wget -O clearcache "https://raw.githubusercontent.com/Rmblvpn1/V4/main/menu/clearcache.sh"
