...
# (C) Copyright 2021-2022 By RMBL VPN
...
echo -e "           OWNER : ${GREEN} BTR ${NC}${YELLOW}(${NC} ${GREEN}SC BY RMBL VPN ${NC}${YELLOW})${NC}"

echo -e "       © Copyright By RMBL VPN ${YELLOW}(${NC} 2022-2023 ${YELLOW})${NC}"
